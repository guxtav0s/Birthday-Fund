/*
 ...
 Para alternar entre mock e API real, altere a variável USE_MOCK para false
 e atualize API_BASE_URL com o endpoint correto. As chamadas internas
 para fetch() estão indicadas/comentadas como exemplo.
*/

document.addEventListener('DOMContentLoaded', function(){
  // Mudar para false quando a API real estiver pronta e ajustar API_BASE_URL
  const USE_MOCK = true;
